        ...
        <div className="relative overflow-hidden bg-cover bg-center h-screen bg-nautral-200">
            ...
            <div className='grid grid-cols-4 gap-4 '>
                ...
                <div className='bg-white p-6 rounded-lg shadow-lg hover:scale-105 cursor-pointer duration-300 ease-out'>
                    ...
                    <a href="https://github.com/JINX23606/Manim-Supply-Curve.git" className="bg-blue-500 text-white font-bold py-2 px-4 mt-2 rounded-lg transition-transform transform hover:scale-105 hover:bg-blue-700 inline-block text-center mb-3" target="_blank" rel="noopener noreferrer font-custom">View Code</a>
